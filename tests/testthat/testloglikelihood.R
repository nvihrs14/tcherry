...
test_that("error messages work", {
  ...
  expect_error(loglikelihood(cliques, separators_wrong, data = data),
...
test_that("Warning message works", {
  expect_warning(loglikelihood(cliques, separators, data_na, smooth = 0.1),
...
test_that("results are correct", {
  expect_equal(loglikelihood(cliques, separators, data, smooth = 0.1),
               -643.6642, tolerance = 10e-5)
  expect_equal(loglikelihood(cliques, separators, data_mat, smooth = 0.1),
               -643.6642, tolerance = 10e-5)
})
